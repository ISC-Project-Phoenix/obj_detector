...
ObjDetectorNode::ObjDetectorNode(const rclcpp::NodeOptions& options) : Node("ObjDetectorNode", options) {
    ...
    // Pub Sub
    this->sub =
        this->create_subscription<std_msgs::msg::String>("/str", 1, std::bind(&ObjDetectorNode::sub_cb, this, _1));
...
void ObjDetectorNode::sub_cb(const std_msgs::msg::String::SharedPtr msg) {
    // Echo message
